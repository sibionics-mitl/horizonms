...
from configs.config_atlas import get_experiment_config 
from aimachine import transforms as T
from aimachine.datasets_utils.atlas import get_atlas

from horizonms.datasets import AtlasSegmentation
...
if __name__ == "__main__":
    ...
    margin = 0
    random = False
    dataset_aimachine = get_atlas(root=dataset_params['root_path'], 
    ...
    dataset_horizonms = AtlasSegmentation(
