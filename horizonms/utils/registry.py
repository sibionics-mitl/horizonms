...
def build_from_cfg(cfg: Dict,
    ...
    elif inspect.isclass(obj_name) or inspect.isfunction(obj_name):
        obj_cls = obj_name
    else:
        raise TypeError(
...
# def build_from_cfg(module_params):
#     module_name = module_params["name"]
#     module_params.pop("name")
#     return eval(module_name)(**module_params)
