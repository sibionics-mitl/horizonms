...
@NETS.register_module()
def mobilenet_v2(input_dim: int = 3, pretrained: str = '', progress: bool = True, model_dir: str = '.', **kwargs: Any) -> MobileNetV2:
    """
    ...
    """
    model = MobileNetV2(input_dim=input_dim, **kwargs)
    if (pretrained == 'imagenet') & (input_dim == 3):
        state_dict = load_state_dict_from_url(model_urls['mobilenet_v2'], model_dir=model_dir,
                                              progress=progress)
